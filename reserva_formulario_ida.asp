...
<tr><td><input type="hidden" name="destino" value="<% response.Write(destino) %>" ></td></tr>
<tr><td><input type="hidden" name="origen" value="<% response.Write(origen) %>" ></td></tr>
...
<p><a href="vuelos.asp">Volver atras</a><p/>
