...
<!-- FORMULARIO PARA CONSULTAR TODAS LAS RESERVAS DE UNA PERSONA, REQUIERE DNI + ID RESERVA, TAL COMO SE ESPECIFICA EN EL ENUNCIADO -->
...
<form method="post" action="reservas_individual.asp">

<table>
<tr><b>CONSULTA RESERVA</b><br><br></tr>
<tr><td>DNI: </td><td><input type="text" name="dni" required></td></tr>
<tr><td>ID Reserva: </td><td><input type="text" name="idreserva" required></td></tr>
